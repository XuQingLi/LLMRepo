...
model_path = "/t9k/mnt/lxq/FineTuning/LLM-Finetune/qwen/Qwen2-1___5B-Instruct"
...
model = PeftModel.from_pretrained(model, model_id="/t9k/mnt/lxq/FineTuning/LLM-Finetune/zh_cls_fudan-news/output/Qwen2/checkpoint-500")
